...
staging_events_copy = ("""
    ...
    region 'us-east-1' format as JSON {log_json_path}
...
staging_songs_copy = ("""
    ...
    credentials 'aws_iam_role={role_arn}'
    region 'us-east-1' format as JSON 'auto';
...
create_table_queries = [create_staging_event_table, create_staging_songs_table, create_songplay_table, create_user_table, create_song_table, create_artist_table, create_time_table]
